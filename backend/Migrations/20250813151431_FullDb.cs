...
namespace Quark.Migrations
{
    ...
    public partial class FullDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuedUtc = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prospect", x => new { x.TeamId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProspectDataField_Prospect_TeamId_ProspectId",
                        columns: x => new { x.TeamId, x.ProspectId },
                        principalTable: "Prospect",
                        principalColumns: new[] { "TeamId", "Id" },
                        onDelete: ReferentialAction.Cascade
                    );
                    table.ForeignKey(
                        name: "FK_ProspectDataField_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProspectDataField_TeamId_ProspectId",
                table: "ProspectDataField",
                columns: new[] { "TeamId", "ProspectId" }
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "ProspectDataField");

            migrationBuilder.DropTable(name: "ProspectListViewItem");
            ...
            migrationBuilder.DropTable(name: "Prospect");

            migrationBuilder.DropTable(name: "TeamRoles");

            migrationBuilder.DropTable(name: "AspNetUsers");

            migrationBuilder.DropTable(name: "Teams");

            migrationBuilder.DropTable(name: "ProspectLayout");
        }
    }
}
