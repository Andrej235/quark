use crate::{
    ...
    types::aliases::{EndpointPathInfo, StructStringPropSize},
};
...
pub const TEAM_INVITATION_YOUNG_OFFSET: i64 = 5; // minutes
...
pub const USER_LOG_OUT_ROUTE_PATH: EndpointPathInfo =
    ("/user/logout/{refresh_token_id}", TypeOfRequest::POST);
pub const USER_RESET_PASSWORD_ROUTE_PATH: EndpointPathInfo =
    ("/user/reset-password", TypeOfRequest::POST);
...
pub const USER_UPDATE_PROFILE_PICTURE_ROUTE_PATH: EndpointPathInfo =
    ("/user/me/profile-picture", TypeOfRequest::PATCH);
pub const USER_UPDATE_DEFAULT_TEAM_ROUTE_PATH: EndpointPathInfo =
    ("/user/me/default-team/{team_id}", TypeOfRequest::PATCH);
pub const VERIFY_EMAIL_ROUTE_PATH: EndpointPathInfo =
    ("/user/email/verify/{email}/{code}", TypeOfRequest::GET);
pub const SEND_VERIFICATION_EMAIL_ROUTE_PATH: EndpointPathInfo =
    ("/user/email/send-verification", TypeOfRequest::GET);
...
pub const TEAM_LEAVE_ROUTE_PATH: EndpointPathInfo =
    ("/team/leave/{team_id}", TypeOfRequest::DELETE);

pub const TEAM_ROLE_CREATE_ROUTE_PATH: EndpointPathInfo =
    ("/team-role/create", TypeOfRequest::POST);
pub const TEAM_ROLE_UPDATE_ROUTE_PATH: EndpointPathInfo =
    ("/team-role/update/{team_role_id}", TypeOfRequest::PUT);
pub const TEAM_ROLE_CHANGE_ROUTE_PATH: EndpointPathInfo = (
    "/team-role/change/{team_id}/{role_id}",
    TypeOfRequest::PATCH,
);
pub const TEAM_ROLE_GET_ROUTE_PATH: EndpointPathInfo = ("/team-role/{team_id}", TypeOfRequest::GET);
pub const TEAM_ROLE_DELETE_ROUTE_PATH: EndpointPathInfo =
    ("/team-role/delete/{team_role_id}", TypeOfRequest::DELETE);

pub const TEAM_INVITATION_SEND_ROUTE_PATH: EndpointPathInfo =
    ("/team-invitations", TypeOfRequest::POST);
pub const TEAM_INVITATION_ACCEPT_ROUTE_PATH: EndpointPathInfo =
    ("/team-invitations/accept/{code}", TypeOfRequest::PATCH);
pub const TEAM_INVITATION_DECLINE_ROUTE_PATH: EndpointPathInfo =
    ("/team-invitations/decline/{code}", TypeOfRequest::PATCH);

pub const TEAM_MEMBERS_GET_ROUTE_PATH: EndpointPathInfo =
    ("/team/members/{team_id}", TypeOfRequest::GET);
pub const TEAM_MEMBERS_KICK_ROUTE_PATH: EndpointPathInfo =
    ("/team_members/kick/{team_id}", TypeOfRequest::DELETE);

pub const WEBSOCKET_ROUTE_PATH: EndpointPathInfo = ("/ws", TypeOfRequest::GET);
pub const WEBSOCKET_SEND_MESSAGE_ROUTE_PATH: EndpointPathInfo =
    ("/ws/{team_id}", TypeOfRequest::POST);
