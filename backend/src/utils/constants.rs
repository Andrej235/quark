...
pub const TEAM_CREATE_ROUTE_PATH: (&'static str, TypeOfRequest) = ("/team/create", TypeOfRequest::POST);
pub const TEAM_UPDATE_ROUTE_PATH: (&'static str, TypeOfRequest) = ("/team/update/{team_id}", TypeOfRequest::POST);
pub const TEAM_DELETE_ROUTE_PATH: (&'static str, TypeOfRequest) = ("/team/delete/{team_id}", TypeOfRequest::POST);
