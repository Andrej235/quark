...
pub const TEAM_INVITATION_YOUNG_OFFSET: i64 = 1; // minutes
...
pub const TEAM_NAME_MIN_LENGTH: StructStringPropSize = 1;
pub const TEAM_NAME_MAX_LENGTH: StructStringPropSize = 150;
