...
#[openapi(
    ...
    paths(sign_up, log_in, log_out, refresh, verify_email, send_email_verification, reset_password, check),
    components(schemas(CreateUserDTO, LogInResultDTO, SRouteError, JWTRefreshTokenPairDTO, PasswordResetDTO)),
    tags(
