...
{
    public async Task<Result> Update(UpdateTeamRoleRequestDto request, ClaimsPrincipal claims)
    {
        ...
        var mapped = updateRequestMapper.Map(request);
        return await updateService.Update(mapped);
    }
}
